...
const CompPokemonCard = ({
  ...
  const compPokemonImageURL =
    compPokemon.sprites.other.dream_world.front_default;
  ...
  return (
    <div id="comp-card" className="comp-card">
      <h2>{name}</h2>
      <p className="card-p">computer's pokemon</p>
      <img src={compPokemonImageURL}></img>
      <p className="cardweight-p" id="comp-weight">
        "you think you're heavy bro?"
      </p>
